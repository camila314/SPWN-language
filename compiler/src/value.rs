...
pub fn convert_type(
    ...
    Ok(match (val, typ) {
        ...
        (Value::Number(n), type_id!(group)) => Value::Group(Group::new(*n as i64)),
        (Value::Number(n), type_id!(color)) => Value::Color(Color::new(*n as i64)),
        (Value::Number(n), type_id!(block)) => Value::Block(Block::new(*n as i64)),
        (Value::Number(n), type_id!(item)) => Value::Item(Item::new(*n as i64)),
                        ...
                        match id.class_name {
                            IdClass::Group => {
                                if id.unspecified {
                                    ...
                                    Value::Group(Group::new(id.number.into()))
                                }
                            }
                            IdClass::Color => {
                                if id.unspecified {
                                    ...
                                    Value::Color(Color::new(id.number.into()))
                                }
                            }
                            IdClass::Block => {
                                if id.unspecified {
                                    ...
                                    Value::Block(Block::new(id.number.into()))
                                }
                            }
                            IdClass::Item => {
                                if id.unspecified {
                                    ...
                                    Value::Item(Item::new(id.number.into()))
                                }
                            }
                        },
                        globals,
